...
h.nnoremap("<leader>z", "<cmd>ZenMode<CR>", { desc = "Explorer" })
...
h.nnoremap("<leader>os", "<cmd>ObsidianQuickSwitch<CR>", { desc = "Obsidian Quick Switch" })
h.nnoremap("<leader>od", "<cmd>ObsidianDailies<CR>", { desc = "Obsidian Dailies" })
h.nnoremap("<leader>ot", "<cmd>ObsidianTemplate<CR>", { desc = "Obsidian Template" })
h.nnoremap("<leader>ob", "<cmd>ObsidianBacklinks<CR>", { desc = "Obsidian Backlinks" })
-- h.nnoremap("<leader>on", "<cmd>ObsidianNew<CR>", { desc = "Obsidian New" })
-- h.nnoremap("<leader>ow", "<cmd>ObsidianTomorrow<CR>", { desc = "Obsidian Tomorrow" })

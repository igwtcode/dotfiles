...
vim.opt.guicursor = {
  "n-v-c:block-blinkon1", -- Normal, visual, command-line: block cursor
  "i-ci-ve:ver25-blinkon1", -- Inset, command-line insert, visual-exclude: vertical bar cusor with 25% width
  "r-cr:hor20-blinkon1", -- Rplace, command-line replace: horizontal bar cursor with 20% height
  "o:hor50-blinkon1", -- Operato-pending: horizontal bar cursor with 50% height
